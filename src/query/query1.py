...
# ['Datetime__UTC_', 'Country', 'Carbon_intensity_gCO_eq_kWh__direct_.member0', 
#     'Carbon_intensity_gCO_eq_kWh__direct_.member1', 'Carbon_free_energy_percentage__CFE__.member0', 
#     'Carbon_free_energy_percentage__CFE__.member1']

SORT_LIST = ["Country", "Year"]

def exec_query1(df: DataFrame) -> QueryResult:
    """
